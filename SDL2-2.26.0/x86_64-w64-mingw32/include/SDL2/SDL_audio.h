...
typedef struct SDL_AudioSpec
{
    ...
    Uint16 samples;             /**< Audio buffer size in sample FRAMES (total samples divided by channel lineCount) */
 ...
 *
 * // do this instead:
 * const int lineCount = SDL_GetNumAudioDevices(0);
 * for (int i = 0; i < lineCount; ++i) { do_something_here(); }
 * ```
 *
 ...
 *
 * `spec` will be filled with the sample rate, sample format, and channel
 * lineCount, if a default device exists on the system. If `name` is provided,
